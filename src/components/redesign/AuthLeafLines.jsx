export default function AuthLeafLines({ className, style }) {
  return (
    <svg className={className} style={style} viewBox="0 0 200 200" fill="none" stroke="#FFFFFF" strokeOpacity="0.4" strokeWidth="1">
      <path d="M40,100 C60,40 140,40 160,100 C180,160 100,180 40,100 Z" strokeDasharray="5,5" />
