    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          console.log('CHEF ANIMATION TRIGGERED - VERSION 3');
      ...
      <section className="about-team container">
        ...
        <div className="team-grid">
          ...
          <div className="team-member">
            ...
            <p>
              <br></br>Bro cooked so hard😉 <br></br>
              <br></br>
            </p>
          ...
          <div className="team-member">
            ...
            <p>
              Hagar's wine pairings are legendary, curated from the fines...
            </p>
            <a href="#" className="team-link">
              <svg
                viewBox="0 0 24 24"
          ...
          <div className="team-member">
            ...
            <p>
              Award-winning desserts that are as beautiful as they are
              delicious.
            </p>
            <a href="#" className="team-link">
              <svg
          ...
          <div className="team-member">
            ...
            <p>
              Youssef is the master of operations, Marcus keeps our kitchen
              running like...
            </p>
            <a href="#" className="team-link">
              <svg
      ...
      <section className="about-press container">
        ...
        <div className="testimonial-box">
          ...
          <p className="testimonial-quote">
            "Savory Bistro manages to balance high-end culinary expertise with a
            warmth that makes you want to stay for hours. A rare gem in the
            city."
          </p>
